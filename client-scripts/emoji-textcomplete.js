! function() {
	...
	return TEXTCOMPLETE_OPTIONS = {
		...
		exodo: ["abrazo","elrisas","esdios","facepalm","gaydude","llorona","nono1","roto2","roto2nuse","roto2rie","sisi1","sisi3","vomito","zplatano2","rolleyes","conejito","qmeparto","bluetroll","gey","sherlock","timidos","aidiomio","qtedoy","dale2","zpalomita","lloron","roto2gaydude","nusenuse","flipa2","jajano","sisi2","copa2","aplauso","roto2gay","number1","zpc","sisi","roto2palm","roto2cafe","nono","salu3","salu2","cantarin","babeando","rota2","loco3","sonrositas","campeon2","risukis","mola","qmiedo","loel","secretito","eing","stick","elboinas","roto2qtemeto","mad","cejas","blabla","feliz","nono3","cocinitas","mrgreen","triste","evilgrin","cacturisas","mmmno","qq","aplauso2","misdies","confundio","deal","excited","writer","exoleto","roto1","toloco","ssj","sirdance"],
		...
		nuevos: ["totalcrazy","lulz","ohnoes","orly","cejitas","jajaein","wat","tantrum","miguitos","simloco","bored","musicon","wtf","heavy","drawer","moonwalk","salido","hyperclap","eaea","periodico","gnomito","boxer","mmm","lolol","rotozzz","ojitos","roto2dios","onusenuse","paraguas","missgreen"],
